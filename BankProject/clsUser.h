...
private:
    ...
    static clsUser _ConvertLinetoUserObject(string Line, string Seperator = "#//#")
    {
        ...
        return clsUser(enMode::UpdateMode, vUserData[0], vUserData[1], vUserData[2],
            vUserData[3], vUserData[4], clsString::DecryptPassword(vUserData[5]), stoi(vUserData[6]));
    ...
    static string _ConverUserObjectToLine(clsUser User, string Seperator = "#//#")
    {
        ...
        UserRecord += clsString::IncryptPassword(User.Password) + Seperator;
    ...
    string _PrepareLogInRecord(string Seprator = "#//#")
    {
        ...
        LoginRecord += clsString::IncryptPassword(Password) + Seprator;
...
public:
    ...
    void RegisterLogIn(string FileName = "LoginRegister.txt")
    {
